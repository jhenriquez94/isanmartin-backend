...
export class MortgageService {
     ...
     */
    static calculateMonthlyPayment(amountUF: number, interestRate: number, years: number) {
     ...
     */
    static async calculateMortgage(amountUF: number, interestRate: number, years: number) {
        ...
        return {
            ...result,
            ufValue,
            amountCLP: parseFloat(amountCLP.toFixed(0)),
            monthlyPaymentCLP: parseFloat(monthlyPaymentCLP.toFixed(0)),
            totalPaymentCLP: parseFloat(totalPaymentCLP.toFixed(0)),
            totalInterestCLP: parseFloat(totalInterestCLP.toFixed(0))
        };
    }
} 