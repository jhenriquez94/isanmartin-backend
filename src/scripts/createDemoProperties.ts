...
import { Property, PropertyType, PropertyStatus, PropertyAction, PriceCurrency } from '../entities/Property';
  ...
  try {
    ...
    const demoProperties = [
      {
        ...
        action: PropertyAction.VENTA,
        mainPriceCurrency: PriceCurrency.UF,
        images: [
      ...
      },
      {
        ...
        surface: 120,
        status: PropertyStatus.DISPONIBLE,
        action: PropertyAction.ARRIENDO,
        mainPriceCurrency: PriceCurrency.UF,
        images: [
    ...
    for (const propertyData of demoProperties) {
      ...
      const property = propertyRepository.create({
        ...propertyData,
        priceCLP,
        images: imagesText // Guardar como texto
      });
