...
class UFService {
     ...
     */
    static async getUFValue(forceUpdate = false) {
        const now = Date.now();
     ...
     */
    static async convertUFToCLP(amountUF) {
     ...
     * @returns Monto en UF
     */
    static async convertCLPToUF(amountCLP) {
        const ufValue = await this.getUFValue();
...
UFService.API_URL = 'https://mindicador.cl/api';
UFService.ufValue = null;
UFService.lastFetchTime = 0;
UFService.CACHE_TIME = 3600000; // 1 hora en milisegundos
